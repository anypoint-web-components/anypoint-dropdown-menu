 ...
 */
export class AnypointDropdownMenu {
  ...
  readonly _selectedItem: HTMLElement;
  ...
  /**
   * @returns Template for the floating label element.
   */
  _labelTemplate(): TemplateResult;

  /**
   * @returns Template for the input (like) element.
   */
  _inputTemplate(): TemplateResult;

  /**
   * @returns Template for the dropdown element.
   */
  _dropdownTemplate(): TemplateResult;

  /**
   * @returns Template for the assistive labels.
   */
  _assistiveTemplate(): TemplateResult;
}

export interface AnypointDropdownMenu extends ControlStateMixin, ValidatableMixin, LitElement {
